...
class CacheableTest < MiniTest::Unit::TestCase
  ...
  def test_cache_key_for_handles_nested_everything_and_removes_hash_keys_with_nil_values
    expected = %|{:foo=>\"bar\", :bar=>[1, [\"a\", \"b\"], 2, {:baz=>\"buzz\"}], \"qux\"=>{:red=>[\"blue\", \"green\"], :day=>true, :night=>nil, :updated_at=>2011-06-29 11:47:47 -0400, :published_on=>Wed, 29 Jun 2011}, :format=>text/html}|
